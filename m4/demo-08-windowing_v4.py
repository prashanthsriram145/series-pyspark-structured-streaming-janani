...
if __name__ == "__main__":
    ...
    averageCloseWindowDf = stockPricesDf \
            .groupBy(window(stockPricesDf.Date, "7 days", "3 days"), stockPricesDf.Name) \
            .agg({"Close": "avg"}) \
            .withColumnRenamed("avg(Close)", "Average Close")


    averageCloseDf = averageCloseWindowDf \
            .orderBy(averageCloseWindowDf.window.start, averageCloseWindowDf.Name)

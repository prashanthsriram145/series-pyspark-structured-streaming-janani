...
if __name__ == "__main__":
    ...
    streamingLifeExpectancyDf = streamingDf.select("Country", "Year", "LifeExpectancy")

    streamingStatusDf = streamingDf.select("Country", "Year", "Status")

    joinedDf = staticDf.join(streamingLifeExpectancyDf, on=["Country", "Year"])\
                       .join(streamingStatusDf, on=["Country", "Year"])
